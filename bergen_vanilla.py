...
class Generator(ABC):
    ...
    def final_evaluate(self, eval_dataset, experiment_mode, train_dataset_name, use_ircan, original_use_cad, save_result, retriever_name):
        ...
        if save_result:
            ...
            # results 저장
            output_file = output_dir / f"llama_2_7b_chat_{train_dataset_name}_{retriever_name}.json"
